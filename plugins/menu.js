...
┆⬡ *Ig* :
┆⬡ https://instagram.com/this_me_kitsune/
┗─────────────────⬣
%readmore`.trim(),
  header: '┏━┈┈『 %category 』┈┈⬣',
...
let handler = async (m, { conn, usedPrefix: _p, args, command }) => {
  ...
  try {
    ...
    await conn.send3TemplateButtonImg(m.chat, fla + teks, text.trim(), wm, `𝐏𝐞𝐧𝐠𝐞𝐦𝐛𝐚𝐧𝐠 𝐁𝐨𝐭`, `${_p}owner`, `𝐃𝐨𝐧𝐚𝐬𝐢`, `${_p}donasi`)
  } catch (e) {
